  ...
  return (
    <header className="w-full bg-primary-midnight-green p-20 relative">
      <div className="grid grid-cols-2 justify-between items-center container gap-[2rem] max-sm:grid-cols-1 max-sm:py-20 max-md:grid-cols-1 max-md:text-center">
        ...
        <div>
          <div className=" h-1 w-[60px] bg-primary-light-coral mb-10 max-sm:hidden max-md:hidden " />
          <p className="font-semibold text-primary-white leading-small max-sm:text-center max-md:text-2xl">
