  ...
  return (
    <header className="w-full bg-primary-midnight-green p-20 relative max-sm:p-10 ">
      <div className="grid grid-cols-2 justify-between items-center container gap-[2rem] max-sm:grid-cols-1 max-sm:py-3 max-sm:pb-50 max-md:grid-cols-1 max-md:pb-50">
        ...
        />
        <h1 className="text-[6rem] font-bold text-primary-white leading-[6.5rem] max-sm:text-center max-md:text-center max-sm:line-clamp max-sxm:font-semibold">
        ...
        <div>
          ...
          <p className="font-semibold text-primary-white leading-small max-sm:text-xl max-sm:text-center max-md:text-3xl max-md:text-center max-sm:line-clamp-6">
          ...
          <img
            ...
            className="absolute right-15 bottom-0 max-sm:mx-auto max-sm:w-[50%] max-md:left-50 max-md:right-50  max-md:w-[50%]"
          />
        </div>
      </div>
    </header>
